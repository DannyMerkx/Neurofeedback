...
dname  ='calibrate_data_s1';
cname  ='clsfr';

%useful functions
load(dname);
% train classifier
clsfr=buffer_train_ersp_clsfr(data,labels,hdr,'spatialfilter','slap','freqband',[6 10 26 30],'badchrm',0,'capFile',capFile,'overridechnms',overridechnm);
